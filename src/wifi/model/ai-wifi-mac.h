...
#ifndef AI_WIFI_MAC_H
#define AI_WIFI_MAC_H
 ...
 */
class AiWifiMac : public InfrastructureWifiMac
{
public:
  ...
  /**
   * Set up WifiRemoteStationManager associated with this AiWifiMac.
   *
...
private:
   ...
   */
  void UpdateCandidateApList (NewApInfo newApInfo);
  ...
  std::vector<NewApInfo> m_candidateAps; ///< list of candidate APs to associate
